// C'EST CRACRA AVEC TOUS CES COMMENTAIRES JE REMETS EN FORME DANS APP.JS
// EN ESSAYANT DE SUIVRE UN DES CONSEILS D'UN DE MES MENTORS= METTRE LES FUNCTIONS DS L'ORDRE ALPHABETIQUE

// NEW essai de passer les links directement ds html
// const url = [
...
function audioPlay() {
  // NEW sorti des eventlistener cf app.js
...
// NEW refacto class en plusieurs fonctions
...
function init() {
  ...
  setTimeout(() => {
    ...
    menuBtns.forEach((element) => {
      element.classList.add("actif");
      element.addEventListener("click", () => {
        spread(parseInt(element.getAttribute("data-ref")));
      });
    });
  }, 3600);
}
